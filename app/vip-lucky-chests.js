...
import { VIP_CHEST_PRIZE_POOL } from "../src/config/economyConfig";
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.body}>
        <Text style={styles.title}>VIP Lucky Chests</Text>
        <Text style={styles.subtitle}>Zero-dud - every chest pays out</Text>
        <LuckyChests prizePool={VIP_CHEST_PRIZE_POOL} onResult={handleResult} />
      </View>
      <PrizeResultModal
...
// FILE LOCATION: app/vip-lucky-chests.js (NEW file)
